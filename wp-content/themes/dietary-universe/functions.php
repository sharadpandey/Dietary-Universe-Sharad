...
'type'=>'array',
'prev_next' => true,
'prev_text'          => __('<i class="fa fa-long-arrow-left" aria-hidden="true">Previous</i>'),
'next_text'          => __('<i class="fa fa-long-arrow-right" aria-hidden="true">Next</i>'),
