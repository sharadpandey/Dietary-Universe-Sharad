 ...
 * @author Never Settle
 * @since 1.0.0
 * @copyright Copyright (c) 2012-2017, Never Settle (dev@neversettle.it)
...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	...
	if ( ! class_exists( 'NS_FBA' ) ) {
		...
		class NS_FBA {
			 ...
			 *
			 * @var obj $wc is a local instance of the woocommerce helper class
			 * @var obj $utils is a local instance of the utils helper class
			 * @var obj $maint is a local instance of the maint helper class
			 * @var obj $inventory is a local instance of the inventory helper class
			 * @var obj $outbound is a local instance of the outbound helper class
			 *
			 */
			public $wc;
			public $utils;
			...
			*/
			...
			private function __construct() {
				...
				// uncomments this in the future when complete and tested
				...
				if ( $this->is_configured ) {
					...
					! empty( $this->options['ns_fba_sync_ship_status']  ) ) {
						...
						if ( ! empty( $this->options['ns_fba_sync_ship_status'] ) )
					...
					if ( ! empty( $this->options['ns_fba_display_order_tracking'] ) ) {
